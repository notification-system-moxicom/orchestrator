...
require (
	...
	github.com/notification-system-moxicom/persistence-service v0.0.0
...
replace github.com/notification-system-moxicom/persistence-service => ../persistence-service
